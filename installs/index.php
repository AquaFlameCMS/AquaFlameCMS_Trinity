...
<body>
	...
	<span>
	<select name="expansion" tabindex="1" required="required" >
	<option value="0" selected="selected">Expansion</option>
	<option value="0">Classic</option>
	<option value="0">Burning Crusade</option>
	<option value="0">Wrath Of The LichKing</option>
	<option value="0">Cataclysm</option>
	<option value="0">Mist Of Pandaria</option>
	</select>
	</span>
	Username Admin:
	<input type="text" name="usernames">
	Your Name:
	<input type="text" name="nameweb">
	E-mail:
	...
	if (isset($_POST["Submit"])) {
		$string = '<?php
/**
 * Copyright (C) '.date('Y').' AquaFlameCMS <http://aquaflame.org/>
 *
...
if ($maintenance == true) {
    if (!isset($bucle_mant)) {
        header(\'Location: '.BASE_URL.''.BASE_URL.'maintenance.php\');
    }
} else {
