...
INSERT INTO `forum_threads` (`id`, `forumid`, `name`, `author`, `replies`, `views`, `date`, `content`, `locked`, `has_blizz`, `prefix`, `last_date`, `edited`, `editedby`) VALUES
	...
	(13, 4, 'Another damn post in Suggestions!', 1, 0, 1, '2013-08-11 23:37:15', 'Suggestions: 0', 0, 1, 'none', '2013-08-11 23:37:15', 0, 0);
...
-- Dumping structure for table website.pve_mode
...
-- Dumping data for table website.pve_mode: 9 rows
...
-- Dumping structure for table website.pvp_mode
...
-- Dumping data for table website.themes: ~3 rows (approximately)
DELETE FROM `themes`;
...
INSERT INTO `users` (`id`, `avatar`, `blizz`, `class`, `firstName`, `lastName`, `character`, `vote_points`, `donation_points`, `char_realm`, `registerIp`, `country`, `birth`, `quest1`, `ans1`) VALUES
	(1, 'eagle.gif', 1, 'blizz', 'Founder', 'OWNER', 0, 101, 20, 1, '0-0-0-0', 'WW', '1990-04-10', 1, 'its 1');
