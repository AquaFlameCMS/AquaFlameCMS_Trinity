...
<!--<![endif]-->
<head>
<title><?php echo TITLE ?> - <?php echo $Shop['shop_51']; ?></title>
		...
		<div class="content-top">
			<div class="content-trail">
				<ol class="ui-breadcrumb">
					...
					<li class="last"><a href="<?php echo BASE_URL ?>shop/faction-change/" rel="np"><?php echo $Shop['shop_51']; ?>
					</a></li>
				</ol>
			</div>
			<div class="content-bot">
				<div class="summary">
					...
					<div class="button-section">
						<a class="ui-button button4 button-apply " href="<?php echo BASE_URL ?>account/change_faction.php"> <span>
