		...
		<div class="content-top">
			<div class="content-trail">
				<ol class="ui-breadcrumb">
					...
					<li class="last"><a href="<?php echo $website['root']; ?>shop/recruit-a-friend/" rel="np"><?php echo $Shop['shop_38']; ?>
					</a></li>
				</ol>
			</div>
			<div class="content-bot">
				<div class="summary-div">
					...
					<div class="button-section">
						<a class="ui-button button4 button-apply " href="<?php echo $website['root']; ?>account/raf-invite" > <span>
				...
				<div class="summary-div-bottom">
					<div class="desc">
						...
						<p>
							...
							<a href="<?php echo $website['root']; ?>account/raf-invite"><?php echo $Shop['shop_47']; ?>
						</p>
						<p>
