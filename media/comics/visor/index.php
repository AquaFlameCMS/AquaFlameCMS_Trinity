...
<a href="<?php echo $website['root'];?>media/comics/" rel="np">
Comics
</a>
</li>
</ol>
...
<?php
        ...
        $images = mysql_query("SELECT * FROM media WHERE visible = '1' AND type ='4'");
...
style="background-image:url(../../../images/media/comics/<?php echo $thumb['id_url']; ?>);background-size: 120px 75px;"
...
mysql_select_db($server_db) or die(mysql_error());
$meta_data = mysql_fetch_assoc(mysql_query("SELECT * FROM media WHERE visible = '1' AND type ='4' and id = '".$_GET['id']."'"));
        ?>
</div>
</div>
</div>
...
<a class="format" href="../../../images/media/comics/<?php echo $meta_data['url']; ?>" onclick="window.open(this.href);return false;">
