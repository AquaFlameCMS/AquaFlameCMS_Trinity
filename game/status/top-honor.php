...
<div id="predictad_div" class="predictad" style="display: none; left: 788px; top: 104px; width: 321px; "></div>
<div id="wrapper">
<?php 
$page_cat="game";
include("../../header.php");
		...
		<div class="content-top">
			<div class="content-trail">
				<ol class="ui-breadcrumb">
					<li>
					<a href="index" rel="np"><?php echo $website['title']; ?>
					</a>
					...
					<li class="last children"><a href="" rel="np">
					<?php
