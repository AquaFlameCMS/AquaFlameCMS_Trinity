...
$page_cat = "services";
//include("functions/arena_items_func.php"); <- need Fix
?>
...
<html>
<head>
<title><?php /*echo $name = $_GET['name'];  need fix*/?> - <?php echo $website['title']; ?></title>
...
//]]>
	...
	<li class="last children"><a href="arena.php" rel="np"><?php /*echo $name = $_GET['name']; need fix*/?></a>
	</li>
	</ol>
	</div>
