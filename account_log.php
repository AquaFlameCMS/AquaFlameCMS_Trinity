		...
		<div id="left">
			...
			<div id="embedded-login">
				...
				<ul id="help-links">
					...
					<?php echo $Log['Log12']; ?>
					<a href="register.php"><?php echo $Log['Log13']; ?>
					</a>! </li>
					<li class="icon-secure">
					<?php echo $Log['Log14']; ?>
					<a href="#"><?php echo $Log['Log15']; ?>
					</a>
					</li>
				</ul>
				<br/><br/>
