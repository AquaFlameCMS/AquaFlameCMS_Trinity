...
<p class="short">You broke <?php echo $website['title']; ?> Management Page, Please wait while we are using our best engineers to fix the problem, it will only take 5 seconds. Thank you for your patience!</p>
<div class="twitter">
