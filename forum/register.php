...
<![endif]-->
<link rel="stylesheet" type="text/css" href="<?php echo BASE_URL ?>wow/static/css/error/error.css"/>
<!--[if LT IE 9]>
<style>
...
<p class="short">You broke <?php echo TITLE ?> Registration Page, Please wait while we are using our best engineers to fix the problem, it will only take 5 seconds. Thank you for your patience!</p>
<div class="twitter">
