<?php
	...
	echo '<link rel="stylesheet" type="text/css" media="all" href="'.BASE_URL.'wow/static/Themes/'.$CSS_LINK.'/css/community/community.css" />';
	...
	echo '<link rel="stylesheet" type="text/css" media="all" href="'.BASE_URL.'wow/static/Themes/'.$CSS_LINK.'/css/cms.css" />';
}
}
