<div id="header">
	...
	<div class="header-plate">
		<ul class="menu" id="menu">
			...
			?>
			<li class="menu-home"><a href="<?php echo $website['root']; ?>" <?php if($page_cat=='home') echo'class="menu-active"';?>
			...
			<li class="menu-forums"><a href="<?php echo $website['root']; ?>forum/" <?php if($page_cat=='forums') echo'class="menu-active"';?>
			><span><?php echo $Forums['Forums']; ?>
			</span></a></li>
			<li class="menu-services"><a href="<?php echo $website['root']; ?>shop/" <?php if($page_cat=='shop') echo'class="menu-active"';?>
		...
		<li class="menu-home"><a href="<?php echo $website['root']; ?>"><span><?php echo $home['home']; ?>
		</span></a></li>
		...
		<li class="menu-forums"><a href="<?php echo $website['root']; ?>forum/"><span><?php echo $Forums['Forums']; ?>
		</span></a></li>
		<li class="menu-services"><a href="<?php echo $website['root']; ?>shop/"><span><?php echo $Shop['shop']; ?>
		</span></a></li>
	</ul>
