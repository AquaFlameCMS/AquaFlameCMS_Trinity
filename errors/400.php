...
<li class="last"><a href="shop.php" rel="np"><?php echo $Errors['400']; ?></a></li>
</ol>
</div>
<div class="content-bot">
	<div id="server-error">
		<h2 class="http">Four,<br /> oh: Zero.</h2>
		<h3> Bad Request</h3>
		<p>The request <br /> cannot be <strong>fulfilled due to bad syntax.</strong><br /><em>(Is this what happens to pages that wander into the forest?)</em></p>
		<!-- http : 404 -->
	</div>
</div>
</div>
