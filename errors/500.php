...
<li class="last"><a href="shop.php" rel="np"><?php echo $Errors['500']; ?></a></li>
</ol>
</div>
<div class="content-bot">
	<div id="server-error">
		<h2 class="http">Five,<br /> oh: Zero.</h2>
		<h3> Internal Server Error</h3>
		<p>Internal<br /><strong>Server Error</strong><br /><em>(Is this what happens to pages that wander into the forest?)</em></p>
		<!-- http : 404 -->
	</div>
</div>
</div>
